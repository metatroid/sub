        ...
        var $this = this, // private properties and methods
            ...
            function(e)
            {
              ...
              switch (e.target)
              {
                ...
                case hex.get(0):
                  ...
                  bindedHex && bindedHex.val(hex.val() + (ahex != null ? ahex.val() : ''));
                  color.val('hex', hex.val() != '' ? hex.val() : null, e.target);
                  color.val('a', ahex.val() != null ? parseInt(ahex.val(), 16) : null, e.target);
                  break;
                case bindedHex && bindedHex.get(0):
                  bindedHex.val(bindedHex.val().replace(/[^a-fA-F0-9]/g, '').toLowerCase().substring(0, ahex != null ? 8 : 6));
                  hex.val(bindedHex.val().substr(0, 6));
                  ahex && ahex.val(bindedHex.val().substr(6));
              ...
              if (color.val() != null)
              {
                switch (e.target)
                {
                  ...
                  case bindedHex && bindedHex.get(0):
                    ...
                    ahex && ahex.val(color.val('ahex').substring(6));
                    bindedHex && bindedHex.val(color.val(ahex ? 'ahex' : 'hex'));
                    break;
          ...
          colorChanged =
            function(ui, context)
            {
              ...
              if (bindedHex && context != bindedHex.get(0) && context != hex.get(0)) bindedHex.val(all != null ? (ahex != null ? all.ahex : all.hex) : '');
