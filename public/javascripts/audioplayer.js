...
(function($) {
    $.fn.player = function(settings) {
        ...
        this.each(function() {
            $(this).wrap('<div class="simple-player-container" style="background: rgba(0,0,0,0.5);' + 
                         ' padding: 10px 10px 5px 5px;" />').parent().prepend(
                '<div><ul style="list-style: none; position: relative">' + 
                    '<li class="title" style="position: absolute; left: 50px; color: #aaa; text-shadow: -1px 1px 1px #000; letter-spacing: 3px;">'+ config.title +'</li>' +
                    ...
                    '<li class="progressbar-wrapper" style="display: inline-block; position: relative; bottom: 5px; cursor: pointer; width:' + config.progressbarWidth + ';">' + 
